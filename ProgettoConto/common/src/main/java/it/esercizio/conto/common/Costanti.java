package it.esercizio.conto.common;

/**
 * Costanti.java 
 * costanti per funzionalita applicativo
 *
 * @Change @history
...
public class Costanti {
	...
	public static final String URL_BASE_CONTO = "/conto/bancario"; // url base conto bancario controller 
